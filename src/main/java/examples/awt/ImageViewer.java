...
public class ImageViewer extends JFrame {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 1) // by default program will load AnyExample logo
            new ImageViewer("http://i.cdn.turner.com/sivault/swimsuit/image/2010/10_julie-henderson_20.jpg");
        else
            new ImageViewer(args[0]); // or first command-line argument
    }

    // Class constructor
    ImageViewer(String source) throws MalformedURLException {
